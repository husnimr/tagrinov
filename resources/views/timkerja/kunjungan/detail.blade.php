			...
			<div class="col-md-6">
				...
				<div class="mb-3 d-flex align-items-start">
					...
					<div>
						...
						<div class="fw-semibold">{{ \Carbon\Carbon::parse($kunjungan->tanggal_kunjungan)->locale('id')->translatedFormat('l, d F Y H:i') }}</div>
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<div class="mb-3 d-flex align-items-start">
					...
					<div>
						...
						@if($kunjungan->status_verifikasi === 'Terverifikasi' && $kunjungan->verifiedBy && $kunjungan->verified_at)
							...
							<div class="text small">
								...
								{{ \Carbon\Carbon::parse($kunjungan->verified_at)->locale('id')->setTimezone('Asia/Jakarta')->translatedFormat('j F Y H:i') }}
							</div>
						@endif
					</div>
				</div>
